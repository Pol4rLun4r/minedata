...
export default function MineBuilds() {
  ...
  function deleteVideo(videoId) {
    api.delete(`/api/deletebuild/${videoId}`)
        ...
        <div className='videos_window'>
          <div className='container_videos'>
            <div className='container_addvideo_save'>
              <Link to={'/minebuilds/addbuild'} className='addvideo_link'>
                <img src={iconAddVideo} alt='add build' className='img_saved_link' />
                <div className='title_saved_link'>Add Buiild</div>
              </Link>
            </div>
                  ...
                  return (
                    <>
                      <div className='container_video'>
                        <a key={index + "video"} href={video.url} target="_blank" className='video'>
