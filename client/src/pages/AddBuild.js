      ...
      <div className="window">
        <div className="header_window">
          <div className="logo_window">
            ...
            <div className="title_window">
              ...
              <Link to={'/minebuilds'} className='titles_paths'>
                \Minebuilds
              </Link>
              \AddBuild</div>
          </div>
        ...
        <div className='addvideo_desc_window'>
          <div className='descri'>
            to add a build copy and paste the youtube link in the field below, it works with desktop and mobile links
          </div>
        </div>
